 ...
 * @LastEditTime: 2022-05-07 16:35:19
-->
<template>
  <view class="process-mode">
    <view class="card card-line">
      <view class="card-line-header cardRight" @click="showMode(true)">
        <view><text class="">种类类型</text></view>
        <view>
          <text class="areaName">{{ dataFormMap[showIndex].kindName?dataFormMap[showIndex].kindName:''}}</text>
...
export default defineComponent({
  ...
  setup() {
    ...
    function onConfirm(e){
      dataFormMap[showIndex.value].kindId=e.detail.value.id;;
      dataFormMap[showIndex.value].kindName=e.detail.value.name;
